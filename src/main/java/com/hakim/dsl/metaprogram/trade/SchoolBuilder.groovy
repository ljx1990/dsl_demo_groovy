...
def builder = new ObjectGraphBuilder(classNameResolver: "com.hakim.dsl.metaprogram.trade",classLoader: getClass().classLoader) // Need classLoader when in Groovy console.
